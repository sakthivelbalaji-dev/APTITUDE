  ...
  return (
    <PageLayout>
      <div className="text-center mb-6">
        <h1 className="text-2xl font-bold text-white mb-2">Your Result</h1>
      ...
      <Card className="space-y-4">
        ...
        <div className="grid grid-cols-2 gap-4 text-sm">
          <div className="bg-capgemini-dark/50 p-3 rounded-lg">
          ...
          <div className="bg-capgemini-dark/50 p-3 rounded-lg col-span-2">
            <p className="text-slate-500">Department</p>
            <p className="font-semibold">{result.department}</p>
          </div>
          <div className="bg-capgemini-dark/50 p-3 rounded-lg">
            <p className="text-slate-500">Total Questions</p>
            <p className="font-semibold text-capgemini-light">{result.total_questions}</p>
          </div>
          <div className="bg-capgemini-dark/50 p-3 rounded-lg">
            <p className="text-slate-500">Score</p>
            <p className="font-semibold text-capgemini-light">{result.score}</p>
          </div>
          <div className="bg-capgemini-dark/50 p-3 rounded-lg">
          ...
          <div className="bg-capgemini-dark/50 p-3 rounded-lg col-span-2 text-center">
            <p className="text-slate-500">Percentage</p>
            <p className="text-3xl font-bold text-capgemini-light">{result.percentage}%</p>
          </div>
        </div>
